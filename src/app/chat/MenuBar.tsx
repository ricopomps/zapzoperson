...
import DissaperingMessage from "@/components/DissapearingMessage";
  ...
  if (theme === "dark") {
    return (
      <span title="Enable light theme">
        <Moon className="cursor-pointer" onClick={() => setTheme("ligth")} />
      </span>
    );
  }
...
function PushSubscriptionToggleButton() {
  ...
  return (
    <div className="relative">
      ...
      {confirmationMessage && (
        <DissaperingMessage className="absolute left-1/2 top-8 z-10 -translate-x-1/2 rounded-lg bg-white px-2 py-1 shadow-md dark:bg-black">
          {confirmationMessage}
        </DissaperingMessage>
      )}
